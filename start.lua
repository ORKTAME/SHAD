...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " المهيب"
SudosS = {1818416834}
Sudos = {sudoid,1818416834}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = '᭡ : تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "المهيب"),data="delnamebot"}},
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : لتفعيل بوت هنا .',url="t.me/U2257"}},
}
}
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "المهيب"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "المهيب"),"اني لقميل "..(redis:get(bot_id..":namebot") or "المهيب"),(redis:get(bot_id..":namebot") or "المهيب").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "المهيب") then
...
local UserId_Info = bot.searchPublicChat("U2257")
if UserId_Info.id then
...
{{text = '᭡ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/jajraw"}},
}
}
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '᭡ : 𝗧𝗜𝗺 𝗪𝗮𝗥𝗞 .',url="https://t.me/jajraw"}},
}
}
...
local Text = "*᭡ : WeLCoMe To 𝗧𝗜𝗺 𝗪𝗮𝗥𝗞  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᭡ : 𝗧𝗜𝗺 𝗪𝗮𝗥𝗞 .',url="https://t.me/jajraw"}},
{{text = '᭡ : inFo 𝗧𝗜𝗺 𝗪𝗮𝗥𝗞 .',url="https://t.me/jajraw"}},
{{text = '᭡ : CoDeR .',url="https://t.me/U2257"},{text = '᭡ : TwS .',url="https://t.me/U2257"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/jajraw&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
